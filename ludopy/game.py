...
class Game:
    ...
    def __init__(self, ghost_players=[1,3]):
        """
        Maked a game with 2 players
    ...
    # seen_from parameter refer to the player that we want to return the pieces, all the other pieces are returned into a list of enemy pieces.
    ...
    # Returns a snapshot of the moment 'i'.
    ...
    def reset(self):
        ...
        self.current_move_pieces = [] # List of the pieces that can be moved.
        self.current_enemys = []
    ...
    def _gen_observation(self, player_idx, roll_dice=True):
        ...
        # Specific for two players.
        enemy_formatted = None

        if self.current_player == 0:
            enemy_formatted = enemy_pieces[1]
        ...
        return (dice, np.copy(move_pieces), np.copy(player_pieces),
                enemy_formatted, player_is_a_winner, there_is_a_winner)
    ...
    def get_observation(self):
        ...
        # Add the board and dice before the move to the history.
        self._add_to_hist()
    ...
    def answer_observation(self, piece_to_move):
        ...
        # Add the board after the move to the history.
        self._add_to_hist()
